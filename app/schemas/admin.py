...
class AdminBase(BaseModel):
    first_name: str = Field(..., min_length=1, max_length=100, description="Nombre del administrador")
    last_name: str = Field(..., min_length=1, max_length=100, description="Apellido del administrador")
